...
export const recipeData = [
	{
		...
		instructions:
			'These instructions only apply at the land of hyrule, Put the slab of meat with some chopped potatoes on the pan and stir until you hear a trumpet sound, them serve, trying to break the number o chars of this field, can we see how much text it can hold?',
		image:
